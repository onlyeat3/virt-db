...
pub async fn register(req_param: web::Json<vt_model::VtNodeRegisterParam>,
    ...
    for x in &req_param.metric_history_list {
        ...
        let _ = ActiveModel {
            ...
            avg_duration: Set(x.avg_duration),
            max_duration: Set(x.max_duration),
            min_duration: Set(x.min_duration),
            exec_count: Set(x.exec_count),
            cache_hit_count: Set(x.cache_hit_count),
