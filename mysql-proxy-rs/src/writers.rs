...
pub(crate) async fn write_eof_packet(
    w: &mut PacketWriter,
    s: StatusFlags,
) -> io::Result<()> {
...
pub(crate) async fn write_ok_packet(
    w: &mut PacketWriter,
...
pub(crate) async fn write_prepare_ok<'a, PI, CI>(
    id: u32,
    params: PI,
    columns: CI,
    w: &mut PacketWriter,
...
pub(crate) async fn write_column_definitions_41<'a, I>(
    i: I,
    w: &mut PacketWriter,
    client_capabilities: CapabilityFlags,
...
pub(crate) async fn column_definitions<'a, I>(
    i: I,
    w: &mut PacketWriter,
    client_capabilities: CapabilityFlags,
) -> io::Result<()>
