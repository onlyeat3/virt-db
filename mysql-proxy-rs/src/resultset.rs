...
{
    async fn new(
        result: QueryResultWriter<'a>,
        columns: &'a [Column],
    ) -> io::Result<RowWriter<'a>> {
...
impl<'a> RowWriter<'a> {
    ...
    pub async fn finish_one(self) -> io::Result<QueryResultWriter<'a>> {
